...
public class ClaimsDao {
    ...
    public java.util.UUID delete(java.util.UUID id) {
        dao.delete(Claims.class, id);
        return id;
    }

    /**
     * Retrieve all records Claims.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of Claims
     */
    public List<Claims> select(int maxResult) {
        return dao.select("select a from Claims a", Claims.class, maxResult);
    }
    ...
    public List<Claims> selectAll() {
        return dao.selectAll("select a from Claims a", Claims.class);
    }

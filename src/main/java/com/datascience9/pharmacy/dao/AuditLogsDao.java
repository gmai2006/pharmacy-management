...
public class AuditLogsDao {
    ...
    @Inject
    @Named("DefaultJpaDao")
    public AuditLogsDao(JpaDao dao) {
        this.dao = dao;
    }
    ...
    /**
     * Retrieve all records AuditLogs.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of AuditLogs
     */
    public List<AuditLogs> select(int maxResult) {
        return dao.select("select a from AuditLogs a", AuditLogs.class, maxResult);
    }
    ...
    public List<AuditLogs> selectAll() {
        return dao.selectAll("select a from AuditLogs a", AuditLogs.class);
    }

    /**
     * Create an AuditLogs.
     *
     * @param e the AuditLogs.
     * @return The same AuditLogs.
     */
    public AuditLogs create(AuditLogs e) {
        return dao.create(e);
    }
     ...
     * @return The same AuditLogs.
     */
    public AuditLogs update(AuditLogs e) {
        return dao.update(e);
    }
}

...
public class TasksDao {
    ...
    public java.util.UUID delete(java.util.UUID id) {
        dao.delete(Tasks.class, id);
        return id;
    }

    /**
     * Retrieve all records Tasks.
     *
     * @param maxResult a maximum number of returned records.
     * @return A list of Tasks
     */
    public List<Tasks> select(int maxResult) {
        return dao.select("select a from Tasks a", Tasks.class, maxResult);
    }
    ...
    public List<Tasks> selectAll() {
        return dao.selectAll("select a from Tasks a", Tasks.class);
    }

 ...
 */
package com.datascience9.pharmacy.dao.core;
...
public class DefaultJpaDao implements JpaDao {
    ...
    private static final String UNITNAME = "pharmacy";
    ...
    @Override
    public <E> List<E> selectAllWithParameters(
            String queryStr, Class<E> e, Map<String, Object> params) {
        final EntityManager em = getEntityManager();
        Query query = em.createQuery(queryStr, e);

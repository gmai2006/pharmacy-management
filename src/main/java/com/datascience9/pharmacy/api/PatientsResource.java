...
import com.datascience9.pharmacy.service.PatientsService;
...
public class PatientsResource {
    ...
    @Inject private PatientsService service;

    public PatientsResource() {}

    public PatientsResource(final PatientsService service) {
    ...
    /**
     * InIdempotent method. Update existing Patients.
     *
     * @param obj - instance of Patients.
     * @return Patients.
     */
    @Consumes(MediaType.APPLICATION_JSON)
    @POST
    ...
    public Response findWithLimit(@PathParam("max") String max) {
        ...
        List<Patients> result = service.select(input);
    ...
    public Response selectAll() {
        List<Patients> result = service.selectAll();
